...
execute store result score #x1 floatcalc run data get storage floatcalc:core x[2]
execute store result score #x2 floatcalc run data get storage floatcalc:core y[2]
...
execute store result storage floatcalc:core x[2] int 1 run scoreboard players operation #x1 floatcalc += #x2 floatcalc
# 繰りあがり
