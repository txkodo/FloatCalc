...
scoreboard players operation #n1 floatcalc /= #2^8 floatcalc
scoreboard players operation #n2 floatcalc /= #2^20 floatcalc
scoreboard players operation #n3 floatcalc /= #2^26 floatcalc
scoreboard players operation #a floatcalc /= #2^29 floatcalc
...
scoreboard players operation #a floatcalc *= #2^15 floatcalc
