...
execute if score #_ floatcalc matches 1 run function floatcalc:core/sqrt/odd
execute if score #_ floatcalc matches 0 run function floatcalc:core/sqrt/even
